...
namespace PlotCurves
{
    internal class Curve
    {
        ...
        private static bool globalMinMax = false;
        ...
        public static void GetGlobalMaxMin(float global_minx, float global_miny, float  global_maxx, float global_maxy)
        {
            minx = global_minx;
            miny = global_miny;
            maxx = global_maxx;
